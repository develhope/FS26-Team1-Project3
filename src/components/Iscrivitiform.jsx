...
export default function Iscrivitiform() {
    return (
        ...
        <div id='form_container'>
            <form action="/iscriviti" method='POST' className="form_main">
                ...
                <div className="inputContainer">
                    ...
                    <input type="text" className="inputField" id="username" name='username' placeholder="Username" />
                </div>
                ...
                <div className="inputContainer">
                    ...
                    <input type="password" className="inputField" id="password" name='password' placeholder="Conferma Password" />
                </div>
                <div className="inputContainer">
                    <svg className="inputIcon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2e2e2e" viewBox="0 0 16 16">
                        <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"></path>
                    </svg>
                    <input type="email" className="inputField" name='email' id="password" placeholder="Email" />
                </div>
