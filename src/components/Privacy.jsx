  ...
  return (
    <div className="containerprivacy">
      ...
      <div className="caption">
        ...
        <p>
          Politica sulla Privacy 1. Introduzione La presente politica sulla
          ...
          massima riservatezza e sicurezza. 2. Raccolta dei Dati Personali
          ...
          per valutare la tua idoneità all'adozione di un animale. 3. Utilizzo
          ...
          nostro servizio, se hai acconsentito a riceverle 4. Condivisione dei
          ...
          organizzazioni partner coinvolti nel processo di adozione. 5.
          ...
          personale autorizzato 6. Diritti dell'Utente Hai il diritto di
          ...
          le informazioni fornite sul nostro sito web. 7. Modifiche alla
          ...
          rimanere informato su come proteggiamo i tuoi dati. 8. Contatti Per
          ...
          web. Data dell'ultimo aggiornamento: 11/07/2024
        </p>
      </div>
    </div>
  );
