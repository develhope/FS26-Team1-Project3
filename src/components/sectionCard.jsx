...
const SectionCard = ({ image, name, age, city, description, razza, nameImage, owner }) => {
  ...
  return (
    <div className="container">
      <div className="book" onMouseLeave={handleMouseLeave}>
            ...
            <div className="contatti">
              ...
              {isDropdownVisible && (
                <div className="dropdown" ref={dropdownRef}>
                  <p><b>Nome proprietario:</b> {owner.name}</p>
                  <p><b>Telefono:</b> {owner.phone}</p>
                  <p><b>Email:</b> {owner.email}</p>
                </div>
              )}
              <svg className="iconContatti"
              width= "30px"
              height="30px"
              fill="#7b2cbf"
