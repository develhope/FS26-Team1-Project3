      ...
      <label className="menuButton" htmlFor="check">
        ...
        {isDropdownOpen && <div className="dropdowncontent">
         ...
         <li className="icon-group">
          ...
          <li className="icon-group">
            <Link onClick={handleLoginButton} className="access-icon">
              <svg
                fill="#7b2cbf"
                width="35px"
                height="35px"
          ...
          <li className="icon-group">
            <Link onClick={handleAnnounceButton} className="access-icon">
              <svg
                fill="#7b2cbf"
                height="35px"
                width="35px"
              ...
              >
                ...
                <g>
                  <path
                    className="st0"
                    d="M120.113,139.014c4.529,13.248,13.07,24.156,23.738,31.637c10.672,7.491,23.51,11.665,36.848,11.673
		...
		c-1.182-3.458-1.729-6.9-1.729-10.302C148.904,111.7,150.983,105.281,154.716,99.964z"
                  />
                  <path
                    className="st0"
                  ...
                  <path
                    className="st0"
                    d="M312.969,175.244l-2.182-0.748l2.198,0.756c6.833,2.339,13.846,3.458,20.73,3.458
		...
		C301.931,111.259,302.478,107.809,303.659,104.367z"
                  />
                  <path
                    className="st0"
                    d="M500.324,202.392c-7.478-10.664-18.391-19.209-31.634-23.73h0.008c-6.829-2.339-13.85-3.474-20.753-3.466
		...
		c6.647,2.276,11.936,6.442,15.685,11.751c3.733,5.308,5.812,11.736,5.809,18.304C479.74,242.646,479.192,246.096,478.015,249.546z"
                  />
                  <path
                    className="st0"
                    d="M124.634,259.989c2.343-6.836,3.466-13.854,3.466-20.746c-0.004-13.342-4.183-26.18-11.677-36.852
		...
		c3.732,5.308,5.812,11.736,5.808,18.304C95.839,242.646,95.292,246.096,94.114,249.546z"
                  />
                  <path
                    className="st0"
                    d="M338.475,234.219c-12.318-9.83-25.66-17.973-39.687-23.754c-14.02-5.766-28.774-9.168-43.739-9.168
		...
		C378.254,377.027,377.119,384.698,374.788,391.897z"
                  />
                </g>
              </svg>
            </Link>
